...
public class Point2d extends AbstractPoint {
     ...
     */
    @Override
    public Point2d translate(Point2d point2d, Double[] translateVector) {
        PointOperator.translate(point2d.vector, translateVector);
        return point2d;
    }
    ...
    public Point2d rotate(Double angle) {
        ...
        tempVector[0] = X() * Math.cos(angle) - Y() * Math.sin(angle);
        tempVector[1] = X() * Math.sin(angle) + Y() * Math.cos(angle);
        this.vector[0] = tempVector[0];
        this.vector[1] = tempVector[1];
        return this;
    }
